...
class TerceirizadoSQL
{
    private readonly string _stringDeConexao;

    public TerceirizadoSQL(string conexao)
    {
    ...
    {
        string sql = @"
            INSERT INTO funcionarios_terceirizados
    ...
    {
        string sql = "SELECT * FROM funcionarios_terceirizados";
    ...
    {
        string sql = @"
            UPDATE funcionarios_terceirizados
            SET 
                nome = @nome,
                funcao = @funcao,
                idade = @idade,
    ...
    {
        string sql = "DELETE FROM funcionarios_terceirizados WHERE codigo = @codigo";
